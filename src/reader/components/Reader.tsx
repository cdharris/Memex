...
export default class Viewer extends React.Component<Props, State> {
    ...
    initEventBus(app) {
        ...
        eventBus.on('pagesinit', (e) => {
            console.log('PDFEVENT pagesinit')
        })
        eventBus.on('scalechange', (e) => {
            console.log('PDFEVENT scalechange')
        })
    ...
    constructor(props) {
        ...
        document.addEventListener('webviewerloaded', () => {
            ...
            this.initEventBus(app)
            // app.GlobalWorkerOptions.workerSrc = workerUrl

            app.eventBus.on('pagesinit', (e) => {
                console.log('PDFEVENT pagesinit')
            })
        ...
        return (
            <div>
                <Helmet>
                    ...
                    <script src={'/build/pdf.js'} type="text/javascript" />
                    <script src={'/pdfjs/viewer.js'} type="text/javascript" />

                    <link
                        rel="resource"
                        type="application/l10n"
                        href={'/pdfjs/viewer.properties'}
                    />
                    <link
                        rel="stylesheet"
                        type="text/css"
